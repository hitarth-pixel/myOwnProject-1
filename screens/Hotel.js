        ...
        <ImageBackground
          ...
          <ScrollView>
            <View style={styles.container}>
              <Text style={styles.titleText}>TRAVELLER INFO</Text>
              <Card
                style={{
                  backgroundColor: 'red',
                  borderRadius: 30,
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <TouchableOpacity
                      ...
                      <Image source={{uri:item.photoURL}} style={styles.photoStyle}></Image>
                    </TouchableOpacity>
                  )}
              ...
              <View style={styles.buttonStyleContainer}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    this.props.navigation.navigate('TravelCity',{city:this.state.city,country:this.state.country});
                  }}>
                  <IonIcons
                    name="arrow-redo"
                    color="yellow"
